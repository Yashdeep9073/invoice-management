            ...
            <div class="content">
                <div class="page-header justify-content-between">
                    <div class="page-title">
                        ...
                        <h6>Manage your Paid Payment</h6>
                    </div>
                    <ul class="table-top-head">
                        <li>
                            <a data-bs-toggle="tooltip" onclick="exportToPDF(`paid_payments`)" data-bs-placement="top" title="Pdf"><img
                                    src="assets/img/icons/pdf.svg" alt="img" /></a>
                        </li>
                        <li>
                            <a data-bs-toggle="tooltip" onclick="exportToExcel(`paid_payments`)" data-bs-placement="top"
