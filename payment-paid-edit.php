...
<li>
<div class="page-btn">
<a href="product-list.php" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Billing Details</a>
</div>
</li>
<li>
...
<form action="edit-status.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="accordion-header" id="headingOne">
                        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-controls="collapseOne">
                            <div class="addproduct-icon">
                                <h5><i data-feather="info" class="add-info"></i><span>Billing Details</span></h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        ...
                                        <input type="text" id="invoice_number" name="invoice_number" class="form-control" style="border: 1px solid black;" value="<?php echo htmlspecialchars($row['invoice_number']); ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
                                        <label class="form-label">Total Amount:</label>
                                        <input type="text" id="total_amount" name="total_amount" class="form-control" style="border: 1px solid black;" value="<?php echo htmlspecialchars($row['total_amount']); ?>">
                                    </div>
                                </div>
                                <!-- <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3 add-product">
    ...
    <div class="mb-3 add-product">
        ...
        <select id="payment_method" name="status" class="form-control" style="border: 1px solid black;">
            <option value="0" <?php echo (isset($row['status']) && $row['status'] == 0) ? 'selected' : ''; ?>>Pending</option>
            <option value="1" <?php echo (isset($row['status']) && $row['status'] == 1) ? 'selected' : ''; ?>>Paid</option>
            <option value="2" <?php echo (isset($row['status']) && $row['status'] == 2) ? 'selected' : ''; ?>>Cancelled</option>
            <option value="3" <?php echo (isset($row['status']) && $row['status'] == 3) ? 'selected' : ''; ?>>Refunded</option>
        </select>
    </div>
</div>
                                ...
                                <div class="col-lg-12">
                                    <div class="btn-addproduct mb-4">
                                        <button type="submit" class="btn btn-submit">Update Billing Info</button>
                                    </div>
                                </div>
                            </div>
                        </div>
