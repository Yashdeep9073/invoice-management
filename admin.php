      ...
      <div class="content">
        <div class="page-header">
          ...
          <ul class="table-top-head">
            <li>
              <a data-bs-toggle="tooltip" onclick="exportToPDF(`users`)" data-bs-placement="top" title="Pdf"><img
                  src="assets/img/icons/pdf.svg" alt="img" /></a>
            </li>
            <li>
              <a data-bs-toggle="tooltip" onclick="exportToExcel(`users`)" data-bs-placement="top" title="Excel"><img
