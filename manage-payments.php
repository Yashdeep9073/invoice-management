            ...
            <div class="content">
                <div class="page-header justify-content-between">
                    ...
                    <ul class="table-top-head">
                        <li>
                            <a data-bs-toggle="tooltip" onclick="exportToPDF(`all_payments`)" data-bs-placement="top"
                                title="Pdf"><img src="assets/img/icons/pdf.svg" alt="img" /></a>
                        </li>
                        <li>
                            <a data-bs-toggle="tooltip" onclick="exportToExcel(`all_payments`)" data-bs-placement="top"
