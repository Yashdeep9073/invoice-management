$(document).ready(function () {
  ...
  $(document).on("click", "#filter_search1", function () {
    $("#filter_inputs1").slideToggle("fast");
  });
  $(document).on("click", "#filter_search2", function () {
    $("#filter_inputs2").slideToggle("fast");
  });
  $(document).on("click", "#filter_search3", function () {
    $("#filter_inputs3").slideToggle("fast");
  });
  $(document).on("click", "#filter_search", function () {
...
$(document).ready(function () {
  ...
  if (
    ...
    $(".video-section, .files-carousel, .folders-carousel").each(function () {
      let carousel = $(this);
